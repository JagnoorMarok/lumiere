  ...
  return (
    <section className="sticky top-0 w-full h-screen bg-white overflow-hidden z-0">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        ...
        {/* Bottom Left Text */}
        <div className="absolute bottom-12 left-8 sm:left-12 max-w-lg z-20">
      ...
      <div className="absolute top-0 left-0 w-full h-[35vh] sm:h-[42vh] bg-white mix-blend-screen overflow-hidden z-10 pointer-events-none flex flex-col justify-start">
        {/* Text starts practically touching the navbar */}
        <h1 
          className="w-full text-center text-black font-serif text-[28vw] sm:text-[27vw] leading-[0.8] tracking-tighter whitespace-nowrap select-none pt-[50px] sm:pt-[56px] -ml-2"
        >
          LUMIÈRE
        </h1>
      </div>
